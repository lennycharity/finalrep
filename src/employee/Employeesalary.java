package employee;
	...
	class Employeesalary {
		static float grosssalary,salary,netsalary,hour,tax,RSSB,deduction,hours,extrahour,rate,grosssalaryweek;
	...
	class hourlyemployee extends Employeesalary{
		...
		class weeklyemployee extends Employeesalary{
	...
	int salary = in.nextInt();
		...
		class monthlyemployee extends Employeesalary{
